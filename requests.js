...
export const createApplication = params =>
  request.post(API.create_application, params);
export const getEnvList = () => request.get(API.env_list);
export const getVersionList = params =>
  request.get(API.version_list + "?" + querystring.stringify(params));
export const createItem = params =>
  request.post(API.create_item, params, "json");
export const createFile = params =>
  request.post(API.create_file, params, "file");
